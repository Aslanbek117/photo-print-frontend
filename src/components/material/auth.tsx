...
export  const Auth = (props: Props)  => {
  ...
  async function RegisterUser() {
    ...
    } else if (response.status === false && response.message === "Пользователь с таким имейлом существует. Попробуйте другой") {
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h4 className="modal-title text-uppercase" id="login-modalLabel">Регистрация</h4>
