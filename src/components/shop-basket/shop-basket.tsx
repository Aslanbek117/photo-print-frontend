...
export const ShopBasket = () => {
  ...
  async function CreateInvoice() {
    ...
    const response = await CreateInvoiceDB("", id, ordersIds, nameOrder, lastNameOrder, deliveryAddress, deliveryNumber, finalPrice, 2000, finalPrice + 2000 );
    if (response.status === true && response.message === "ok") {
                ...
                <div className="row">
                  <div className="col-lg-9">
                      ...
                      <p className="text-muted">
                          Наши менеджеры свяжутся с Вами после подтверждения заказа (<strong>онлайн оплата временно отсутствует</strong>)
                        </p>
                      <div className="row">
                  <div className="col-md-6 mb-3">
                    <label className="form-label" >Имя</label>
                    <input className="form-control" id="firstname" type="text" name="firstname" value={nameOrder} onChange={( e) => setNameOrder(e.target.value)} />
                  </div>
                  <div className="col-md-6 mb-3">
                    <label className="form-label" >Фамилия</label>
                    <input className="form-control" id="lastname" type="text" name="lastname" value={lastNameOrder} onChange={(e) => setLastNameOrder(e.target.value)} />
                  </div>
                  <div className="col-md-6 mb-3">
                    <label className="form-label" >Телефонный номер</label>
                    <input className="form-control" id="company" type="text" name="company" value={deliveryNumber} onChange={(e) => setDeliveryNumber(e.target.value)} />
                  </div>
                  <div className="col-md-6 mb-3">
                    <label className="form-label">Адрес доставки</label>
                    <input className="form-control" id="street" type="text" name="street" value={deliveryAddress} onChange={(e) => setDeliverAddress(e.target.value)} />
                  </div>
                </div>
                      <div className="row gx-lg-0 align-items-center bg-light px-4 py-3 text-center mb-5">
                        <div className="col-md-6 text-md-start py-1">
                          <a
                            ...
                            href="/"
                          >
                            <i className="fas fa-angle-left me-1"></i> Обратно в галерею
                          </a>
                        </div>
                  ...
                  <div className="col-lg-3">
                    <div className="mb-5">
                      ...
                      <div className="bg-light py-4 px-3">
                        <p className="text-muted">
                          Сумма высчитывается автоматически исходя из позиций, которые Вы выбрали
                        </p>
                        <div className="table-responsive">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="bg-light py-4 px-3">
                        <p className="text-muted">
                          Если у Вас есть <strong>промокод</strong>, то введите его ниже
                        </p>
                        <form action="#">
